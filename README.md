...
- 🖼 Красивый `/start` с фото и командами
- 📊 Прогресс бар конвертации
- ℹ️ Инфо о файле перед конвертацией
- 🎚 Выбор битрейта для MP3
...
| 🎯 Четкий выбор формата | Удобные inline-кнопки для MP3/WAV/OGG/M4A/FLAC |
| 🎚 Контроль качества | Выбор битрейта для MP3 перед конвертацией |
| 📊 Понятный прогресс | Прогресс бар конвертации с обновлением статуса |
| ℹ️ Информативная подача | Инфо о файле до запуска конвертации |
